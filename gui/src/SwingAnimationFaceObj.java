...
public class SwingAnimationFaceObj extends JPanel implements ActionListener {
    ...
    class BallRim {
        ...
        void changeColor() {
            Color newColor = new Color(rdn.nextInt(255), rdn.nextInt(255), rdn.nextInt(255));
            setBasicColor(newColor);
        }
    ...
    class FaceObj {
        ...
        public void makeEyes(Graphics g, int eyeSize) {
            ...
            g.fillOval(xStart + (h * 2 / 7) + eyeSize / 4, yStart + (w * 1 / 3) + eyeSize / 4, eyeSize / 2, eyeSize / 2);
            g.fillOval(xStart + (h * 4 / 7) + eyeSize / 4, yStart + (w * 1 / 3) + eyeSize / 4, eyeSize / 2, eyeSize / 2);
        }
        ...
        public void makeMouth(Graphics g, int mouthSize) {
            ...
            g.drawArc(xStart + (h / 2) - (mouthSize / 2), yStart + (w * 3 / 4) - 10, mouthSize, 20, 0, -180);
        }

        public void makeEyebrows(Graphics g, int eyebrowSize) {
            g.setColor(Color.black);
            g.drawLine(xStart + (h * 2 / 7), yStart + (w * 1 / 4), xStart + (h * 2 / 7) + eyebrowSize, yStart + (w * 1 / 4));
            g.drawLine(xStart + (h * 4 / 7), yStart + (w * 1 / 4), xStart + (h * 4 / 7) + eyebrowSize, yStart + (w * 1 / 4));
        }

        public void makeBlush(Graphics g, int blushSize) {
            g.setColor(Color.pink);
            g.fillOval(xStart + (h * 1 / 4), yStart + (w * 1 / 2), blushSize, blushSize);
            g.fillOval(xStart + (h * 3 / 4) - blushSize, yStart + (w * 1 / 2), blushSize, blushSize);
        }
